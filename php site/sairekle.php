<?php
    ...
    if ($_POST) {
        ...
        $resim = $_POST["resim"];
        $ozet =  $baglan->real_escape_string($_POST["ozet"]);

        $sql = $baglan->query("delete from ozet where 'isim' and 'ozet'='id'");
        $sorgu = $baglan->query("insert into sairekle (isim,tur,aciklama,resim,ozet) values ('$isim','$tur','$aciklama','$resim','$ozet')");
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Şair Ekle</h6>
                            <form action="sairekle.php" method="post">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Şair isim ve soyisim</label>
                                    <input type="text" name="isim" class="form-control" id="exampleInput">
                                </div>

                                <div class="form-floating mb-3">
                                <select name="tur" class="form-select" id="floatingSelect"
                                    aria-label="Floating label select example">
                                    <option selected>Şairin hangi edebiyat türünde olduğunu seçiniz</option>
                                    <option value="turk">Turk Sair</option>
                                    <option value="yabanci">Yabanci Sair</option>
                                </select>
                                <label for="floatingSelect">Şair Türünü seçiniz</label>
                            </div>
                                ...
                                <textarea class="form-control" name="aciklama" placeholder="Leave a comment here"
				...
				<div class="form-floating">
                        ...
                        <div class="form-floating">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="resim" type="file" id="formFile">
                        </div>
                            </div>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Şair sil</h6>
                            
                             <form action="sairekle.php" method="get">

                             <div class="form-floating mb-3">
                                <select class="form-select" name="ozet"id="floatingSelect"
                                    aria-label="Floating label select example">
                                    	<?php
                                    include("ayar.php");
